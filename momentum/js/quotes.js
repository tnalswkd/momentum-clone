...
// 매번 일일히 세서 숫자를 입력해주긴 어려우니까 quotes array의 길이만큼 random으로 돌려주는 것임
// floor : 소수점 이하를 버림한다.
const todaysOuote = quotes[Math.floor(Math.random() * quotes.length)];

quote.innerText = todaysOuote.quote;
author.innerText = todaysOuote.author;
